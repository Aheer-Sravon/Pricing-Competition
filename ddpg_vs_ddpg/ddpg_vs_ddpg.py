...
import argparse
parser = argparse.ArgumentParser(prog="ddpg_vs_ddpg")
...
def main():
    ...
    print("=" * 80)
    print("DDPG vs DDPG - SCHEME NONE")
    print("=" * 80)
    ...
    df.to_csv("./results/shock_none/ddpg_vs_ddpg.csv", index=False)
    ...
    print("\n[Results saved to ./results/shock_none/ddpg_vs_ddpg.csv]")
