...
def main():
    ...
    print("=" * 80)
    print("PPO vs PPO - SCHEME B")
    print("Scheme B: ρ=0.7, σ_η=0.2 (high persistence, low variance)")
    print("=" * 80)
    ...
    df.to_csv("./results/ppo_vs_ppo_schemeB.csv", index=False)
    
    print("\n" + "=" * 80)
    print("FINAL RESULTS")
    print("=" * 80)
    print(df.to_string(index=False))
    print("\n[Results saved to ./results/ppo_vs_ppo_schemeB.csv]")
