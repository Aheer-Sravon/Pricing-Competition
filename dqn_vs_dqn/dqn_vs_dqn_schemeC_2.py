"""
dqn_vs_dqn_schemeC.py
"""

"""
DQN vs DQN with Scheme C Shocks
Scheme C: ρ=0.95, σ_η=0.1 (high persistence, low variance)
"""
...
def main():
    ...
    print("=" * 80)
    print("DQN vs DQN - SCHEME C SHOCKS")
    print("=" * 80)
    ...
    print(f"\n{'='*80}")
    print("[Results saved to ./results/dqn_vs_dqn_schemeC.csv]")
    print(f"{'='*80}\n")
