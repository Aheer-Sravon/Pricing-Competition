...
from environments.marketenv import MarketEnvContinuous
...
def main():
    ...
    df.to_csv("./results/shock_none/q_vs_q.csv", index=False)
    ...
    print("\n[Results saved to ./results/shock_none/q_vs_q.csv]")
